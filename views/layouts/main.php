    ...
    <header class="container header">
        <div class="row align-items-center">
            ...
            <div class="col-md-3">
                ...
                <?else:?>
                    <a href="#modalSignIn" data-toggle="modal">Sign in</a>
                    &#8195;|&#8195;
                    <a href="#modalRegistration" data-toggle="modal">Registration</a>
                <?endif;?>
            </div>
            <div class="col-md-2">
                <div class="btn-group basket">
                    <button type="button" class="btn btn-primary dropdown-toggle basket__btn" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <div class="basket__ico">
                            ...
                            <span class="badge badge-pill badge-light countProducts" id="mainCount"><?=$count?></span>
                        </div>
                        Basket
                    </button>
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-lg-left" onclick="event.stopPropagation()">
                        <div class="dropdown-item">
                            <div class="basket">
                                <?if ($basket):?>
                                    <table cellspacing="0" class="basketProduct">
                                        <?php foreach ($products as $product) : ?>
                                            <tr class="bodyBasket" id="main<?=$product['id_basket']?>">
                                    ...
                                    <div class="bodyBasket__footer">
                                        <div class="totalBasket">Total: <span>&#36;</span><span id="mainTotal"><?=$total?></span></div>
                ...
                <form action="/user/login/" method="post">
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="login" class="form-control" id="inputLogin" aria-describedby="emailHelp" placeholder="Enter login">
                        </div>
                        <div class="form-group">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" name="submit" class="btn btn-primary signIn">Sign in</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div class="modal fade" id="modalRegistration" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                    ...
                    <form>
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="email" class="form-control" id="inputLoginReg" placeholder="Login">
                            </div>
                            <div class="form-group col-md-6">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                    <button type="button" class="btn btn-primary">To register</button>
                </div>
            </div>
        </div>
    </div>
